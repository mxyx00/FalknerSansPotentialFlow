...
yyy1 = ppval(pp1, logspace(abscissa1(1), abscissa1(end), resolution));
yyy2 = ppval(pp2, logspace(abscissa2(1), abscissa2(end), resolution));


%logspace towards leading and trailing

x = [yyy1(1,:)]'*100 + [yyy2(1,:)]'*100
y = [yyy1(2,:)]'*100 + [yyy2(2,:)]'*100;
